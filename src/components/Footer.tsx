...
export function Footer() {
  ...
  return (
    <div className="flex flex-col w-full justify-center items-center bg-blue-900 text-white pt-4">
      <div id="menu" className="flex flex-col items-center gap-y-4">
      ...
      <span className="inline-block bg-gray-100/30 w-full h-[0.05rem] my-4"></span>
      <div className="h-10">by rtosta</div>
    </div>
  );
}
